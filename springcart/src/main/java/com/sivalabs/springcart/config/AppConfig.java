 ...
 */
@Configuration
@ComponentScan(value="com.sivalabs.springcart", 
				excludeFilters = @Filter(type = FilterType.CUSTOM, value = { WebPackageFilter.class }))
@PropertySource("classpath:application.properties")
@EnableTransactionManagement
@EnableJpaRepositories("com.sivalabs.springcart.repositories")
public class AppConfig {
	...
	public DataSourceInitializer dataSourceInitializer()
	{
		...
		databasePopulator.addScript(new ClassPathResource("sql/springcart.sql"));
...
class WebPackageFilter extends RegexPatternTypeFilter
{
    public WebPackageFilter() {
    	 super(Pattern.compile("com.sivalabs.springcart.web..*"));
    }
}