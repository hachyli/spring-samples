...
<body>
	...
	<div class="span6" style="background-color: #f5f5f5; border: 1px; border-color: black;">
	...
	<h3>Update User:</h3>
	<form:form id="updateUserForm" class="form-horizontal" 
			action="updateUser.htm" method="post" commandName="user">
