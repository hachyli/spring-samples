 ...
 * 
 */
package com.sivalabs.forum.config;
 ...
 */
@Configuration
@ComponentScan(value="com.sivalabs.forum", 
	excludeFilters = @Filter(type = FilterType.CUSTOM, value = { WebPackageFilter.class }))
@PropertySource("classpath:application.properties")
@EnableTransactionManagement
@EnableJpaRepositories("com.sivalabs.forum.repositories")
public class AppConfig {
	...
	public DataSourceInitializer dataSourceInitializer()
	{
		...
		databasePopulator.addScript(new ClassPathResource("sql/forum.sql"));
...
class WebPackageFilter extends RegexPatternTypeFilter
{
    public WebPackageFilter() {
    	 super(Pattern.compile("com.sivalabs.forum.web..*"));
    }
}
